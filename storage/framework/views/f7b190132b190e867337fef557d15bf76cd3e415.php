<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('/assets/images/logo/logo-pinheiro-unicred-preto.svg')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('assets/images/logo/unicred-preto.png')); ?>" alt="" height="17">
                    </span>
                </a>

                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('/assets/images/logo/logo-pinheiro-unicred-branco.svg')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/logo/logo-unicred-branco.svg')); ?>" alt="" height="25">
                    </span>
                </a>
            </div>
        ...
        <a href="./ranking-geral" class="linkCarousel">
                ...
                <div id="carouselRanking" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                            ...
                            <span class="img-fluid"><i class="bx bxs-trophy first"></i> Canoas <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy second"></i> Guaíba <span class="separador"></span></span>
                        ...
                        <div class="carousel-item">
                            ...
                            <span class="img-fluid"><i class="bx bxs-trophy first"></i> Marau <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy second"></i> Venâncio <span class="separador"></span></span>
                        ...
                        <div class="carousel-item active">
                            ...
                            <span class="img-fluid"><i class="bx bxs-trophy first"></i> Capão da Canoa <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy second"></i> Porto Alegre <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy third"></i> Casca </span>
                        </div>
                        <div class="carousel-item">
                            <span class="img-fluid badge badge-soft-dark">Ranking</span>
                            <span class="img-fluid badge badge-soft-success">Grupo 3</span>
                            <span class="img-fluid"><i class="bx bxs-trophy first"></i> Gramado <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy second"></i> Caruaru <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy third"></i> Recife</span>
                        </div>
                        <div class="carousel-item">
                            <span class="img-fluid badge badge-soft-dark">Ranking</span>
                            <span class="img-fluid badge badge-soft-success">Grupo 4</span>
                            <span class="img-fluid"><i class="bx bxs-trophy first"></i> Mãe de Deus <span class="separador"></span></span>
                            <span class="img-fluid"><i class="bx bxs-trophy second"></i> Bento Gonçalves <span class="separador"></span></span>
        ...
        <div class="d-flex">           
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block" href="#" data-bs-toggle="modal" data-bs-target=".change-password"><span class="badge bg-success float-end">11</span><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">Config</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout">Sair</span></a>
...
<script>
  function toggleMode() {
    if (document.getElementById("labelSwitch").className == "bx bxs-moon")
        document.getElementById("labelSwitch").className = "bx bxs-sun";
    else
        document.getElementById("labelSwitch").className = "bx bxs-moon";
}
</script>
...
</div><!-- /.modal --><?php /**PATH C:\Users\mateus.g.0999\Documents\GitHub\template-plataforma-laravel\Admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>