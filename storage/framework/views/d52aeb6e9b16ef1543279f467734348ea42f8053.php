    ...
    <div class="col-xl-12">
      <div class="row mx-0 my-0" style="justify-content: flex-end;">
        <button onclick="hideShow()" type="button"
          class="shrink btn border-primary btn-sm waves-effect waves-light px-2" id="botaoDescricao"><i
            class="fas fa-angle-right" id="iconDescricao"></i> <span id="textoDescricao">Ver regras do Indicador</span></button>
      </div>
    </div>
    ...
    <div class="row mt-2" style="justify-content: flex-end;">
      ...
      <div class="card border border-primary mini-stats-wid">
        <div class="card-body">
          <div class="d-flex">
            <div class="flex-grow-1">
              <p class="badge bg-primary" style="font-size: 100%;"><span class="bx bx-line-chart"></span> Volume
              </p>
            ...
            <div class="flex-grow-1">
              ...
              <h5 class="mb-0"><i class="bx bxs-upvote success"></i> 334<span class="lead descTotalPontos">/1535</span></h5>
            </div>
            <div class="flex-grow-1">
        ...
        <div class="card-footer progressBarBG">
          ...
          <div class="custom-progess mt-3 mb-3">
            ...
            <div class="progress animated-progess progress-lg">
              <div class="progress-bar-striped js-completed-bar progress-bar bg-success rounded-bar" role="progressbar"
                data-complete="70">
              </div>
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mateus.g.0999\Documents\GitHub\template-plataforma-laravel\Admin\resources\views/indicador.blade.php ENDPATH**/ ?>