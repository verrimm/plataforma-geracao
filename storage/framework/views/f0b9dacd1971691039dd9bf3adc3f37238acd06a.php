                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 align-self-center">
                                <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                                    <span class="avatar-title rounded-circle bg-success avatarRanking"> <?php echo e($item['ordem']); ?> </span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Modo noturno -->
<script src="<?php echo e(URL::asset('/assets/js/pages/toggleMode.init.js')); ?>"></script>
<!-- barra de progresso -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mateus.g.0999\Documents\GitHub\template-plataforma-laravel\Admin\resources\views/index.blade.php ENDPATH**/ ?>