...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="mb-3">
                                                <div class="float-end">
                                                    ...
                                                    <a href="<?php echo e(route('password.request')); ?>" class="text-muted">Esqueceu sua senha?</a>
                                                    <?php endif; ?>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p>Precisa de algo? <a href="<?php echo e(url('register')); ?>" class="fw-medium text-primary"> Ajuda </a> </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> Superação. feito com <i class="mdi mdi-heart text-danger"></i> por
                                        Central RS</p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Public\Documents\teste superacao\themeforest-template\Skote_v3.3.2\Laravel\Admin\resources\views/auth/login.blade.php ENDPATH**/ ?>