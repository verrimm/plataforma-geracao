        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('/assets/images/logo-pinheiro-unicred-branco.svg')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/logo-unicred-branco.svg')); ?>" alt="" height="19">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <!-- <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item noti-icon waves-effect">
                        <div>
                            <input class="form-check-input theme-choice" type="checkbox" id="light-mode-switch" hidden="" checked="">
                            <label onclick="toggle()" class="form-check-label" for="light-mode-switch"><i class="bx bxs-moon" id="labelSwitch"></i></label>
                        </div>
                    </button>
            </div>
                <script>
...
</div><!-- /.modal --><?php /**PATH C:\Users\Public\Documents\teste superacao\themeforest-template\Skote_v3.3.2\Laravel\Admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>