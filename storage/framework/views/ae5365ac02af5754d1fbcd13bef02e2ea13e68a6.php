                            ...
                            <div class="custom-progess mt-3 mb-4 d-flex flex-colunm w-100">
                                ...
                                <div style="display: none" id="conteudoMarcoSegundo">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <h6 id="footerMarcoSegundo"><strong><?php echo e($rankingPodio[1]['nm_posto']); ?> |
                                                Pontos:
                ...
                <div class="card border border-primary mini-stats-wid" id="cardFiltro" style="display: none;">
                    <div class="card-body" style="margin-top: 5%">
                        <form action="">
                            ...
                            <div class="input-group" style="justify-content: space-evenly; margin-top: 15px">
                                    ...
                                    <div class="flex-grow-1">
                                        <?php if (! ($item['label_vl_extra_1'] == null)): ?>
                                            <h6 class="lead"><small><i class="bx bx-wallet"></i> <strong
                                                        style="font-weight: 500;"><?php echo e($item['label_vl_extra_1']); ?>:</strong>
                                                    <span
                                                        style="font-weight: 300;"><?php echo e($item['prefixo_1']); ?><?php echo e(number_format($item['vl_extra_1'], 0, ',', '.')); ?><?php echo e($item['sufixo_1']); ?></span></small>
                                            </h6>
                                        <?php endif; ?>
                                        <h6 class="lead"><small><i class="bx bx-food-menu"></i> <strong
                                                    style="font-weight: 500;"><?php echo e($item['label_vl_extra_2']); ?>:</strong>
                                                <span
                                                    style="font-weight: 300;"><?php echo e($item['prefixo_2']); ?><?php echo e(number_format($item['vl_extra_2'], 0, ',', '.')); ?><?php echo e($item['sufixo_2']); ?></span></small>
                                        </h6>
                                    </div>
                                </div>
                            </div>
