...
<div class="row">
    <div class="col-xl-12 d-flex flex-column align-items-end">
        <div class="row mx-0 my-2 col-lg-4" style="justify-content: flex-end;">
        ...
        <div class="card col-lg-4 border border-primary mini-stats-wid" id="cardFiltro" style="display: none;">
            <div class="card-body">
                <div class="row">
                </div>
                <form action="">
                    ...
                    <div class="custom-progess mt-3 mb-4">
                        ...
                        <div class="avatar-xs progress-icon-end">
                            <span class="avatar-title-card border iconePosicaoRanking">{{
                                $rankingPodio[0]['posicao_ranking']}}º</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex" style="justify-content: space-evenly; ">
                                <div class="flex-grow-1">
                                    ...
                                    <h6 class="lead"><small><i class="bx bx-wallet"></i> <strong style="font-weight: 500;">{{$item['label_vl_extra_1']}}:</strong> <span style="font-weight: 300;">{{$item['prefixo_1']}}{{number_format($item['vl_extra_1'], 0, ',', '.')}}{{$item['sufixo_1']}}</span></small></h6>   
                                    @endunless
                                    <h6 class="lead"><small><i class="bx bx-food-menu"></i> <strong style="font-weight: 500;">{{$item['label_vl_extra_2']}}:</strong> <span style="font-weight: 300;">{{$item['prefixo_2']}}{{number_format($item['vl_extra_2'], 0, ',', '.')}}{{$item['sufixo_2']}}</span></small></h6>
                                </div>
                            </div>
                        </div>
...
<script src="{{ URL::asset('/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>t
<script src="{{ URL::asset('/assets/js/pages/jbox-tooltips.init.js') }}"></script>
<!-- define cor da posição ranking  -->
<script src="{{ URL::asset('/assets/js/pages/bgColocacao.init.js') }}"></script>
