...
@slot('li_2') Indicadores @endslot
@slot('title') {{$indicador->nm_indicador}} @endslot
@endcomponent
@section('css')
            ...
            <div class="card-body">
              <div class="d-flex mb-4">
                <div class="flex-grow-1">
                  ...
                  <h5 class="mb-0"> {{$indicador["ds_calculo"]}} </h5>
                </div>
              </div>
              <div class="d-flex">
                <div class="flex-grow-1">
                  ...
                  <h5 class="mb-0"> {{$indicador["pontuacao_base"]}} </h5>
                </div>
              </div>
            </div>
          </div>
...
<script src="{{ URL::asset('./assets/js/pages/indicador.js') }}"></script>
<script src="{{ URL::asset('./assets/js/pages/progressMeta.init.js') }}"></script>
